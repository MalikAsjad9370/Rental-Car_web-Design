const headerMenuBtn = document.querySelector('.header_menu');
const headerNavAuth = document.querySelector('.header_nav-auth');
const showMenuIcon = document.querySelector('.header_menu .bx-menu-right');
const hideMenuIcon = document.querySelector('.header_menu .bx-x');
...
const filterBtns = document.querySelectorAll('.cars_list-btn button');
const carCards = document.querySelectorAll('.cars_card');
